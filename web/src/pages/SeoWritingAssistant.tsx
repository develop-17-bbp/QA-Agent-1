...
export default function SeoWritingAssistant() {
  ...
  return (
    <motion.div className="qa-page" initial={{ opacity: 0 }} animate={{ opacity: 1 }} style={{ padding: 32 }}>
      ...
      <p className="qa-page-desc">Analyze any crawled page for content quality, SEO optimization, and readability.</p>
      ...
      {data && !loading && (
        <>
          ...
          <div style={{ display: "flex", gap: 16, marginTop: 16, flexWrap: "wrap" }}>
            ...
            {data.wordCountEstimate && <div className="qa-panel" style={{ padding: 16, flex: 1, minWidth: 130 }}><div className="qa-kicker">Est. Word Count</div><div style={{ fontSize: 16, fontWeight: 600 }}>{data.wordCountEstimate}</div></div>}
          </div>

          {(data.keywordsDetected ?? []).length > 0 && (
            <div className="qa-panel" style={{ marginTop: 16, padding: 16 }}>
              <div className="qa-panel-title">Keywords Detected</div>
