...
const GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "CWV History", path: "/cwv-history", badge: "NEW" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "AI Search Visibility", path: "/ai-search-visibility", badge: "2026" },
      { label: "AEO Optimizer", path: "/aeo", badge: "2026" },
      { label: "SEO Tools (Disavow/Schema/Snippet)", path: "/seo-tools", badge: "NEW" },
